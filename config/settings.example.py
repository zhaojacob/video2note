...
Copy this file to settings.py and modify it according to your needs.
"""
import os
...
VIDEO_CONFIG = {
    ...
    "proxy": None,  # Optional: Set proxy if needed, e.g., "http://127.0.0.1:7890"
    "quality": "best",  # best, worst, or specific format
    # User agent (optional, defaults to standard browser UA)
